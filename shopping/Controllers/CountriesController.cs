        ...
        public async Task<IActionResult> EditState(int id, StateViewModel model)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                catch (DbUpdateException dbUpdateException)
                {
                    if (dbUpdateException.InnerException.Message.Contains("duplicate"))
                    {
                        ModelState.AddModelError(string.Empty, "There is already a state with the same name in this country.");
                    }
                    else
                    {
                        ModelState.AddModelError(string.Empty, dbUpdateException.InnerException.Message);
        ...
        public async Task<IActionResult> AddCity(CityViewModel model)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                catch (DbUpdateException dbUpdateException)
                {
                    if (dbUpdateException.InnerException.Message.Contains("duplicate"))
                    {
                        ModelState.AddModelError(string.Empty, "There is already a city with the same name in state.");
                    }
                    else
                    {
                        ModelState.AddModelError(string.Empty, dbUpdateException.InnerException.Message);
        ...
        public async Task<IActionResult> EditCity(int id, CityViewModel model)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                catch (DbUpdateException dbUpdateException)
                {
                    if (dbUpdateException.InnerException.Message.Contains("duplicate"))
                    {
                        ModelState.AddModelError(string.Empty, "There is already a city with the same name in this state.");
                    }
                    else
                    {
                        ModelState.AddModelError(string.Empty, dbUpdateException.InnerException.Message);
